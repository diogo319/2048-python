...
def regista_ranking():
    ...
    mensagem = None
    try:
        url_string = "http://ec2-52-18-23-92.eu-west-1.compute.amazonaws.com/cgi-bin/submit_2048.py?numero=" + numero + "&amigos=" + amigos + "&jogadas=" + jogadas + "&pontos=" + str(pontos) + "&semente=" + str(semente)
